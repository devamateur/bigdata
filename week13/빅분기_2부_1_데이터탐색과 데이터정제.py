...
data['industry'].value_counts()   # industry 컬럼의 각 값의 개수


# In[5]:

# industry 컬럼의 1, 2, 3, 4 값을 각각 Service, IT, Finance, Others로 변환
...
data.describe()  # 데이터프레임의 평균, 최소, 최대 등 통계값
...
data.hist(bins=50, figsize=(20,15))  # industry는 연속형 변수가 아니므로 히스토그램에 나타나지 않음
...
# lamda 함수의 apply() 적용, industry컬럼에 대해 lambda식 사용
