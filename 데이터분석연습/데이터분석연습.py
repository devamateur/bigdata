# input
import pandas as pd
x_train=pd.read_csv('../데이터분석연습/x_train.csv', encoding='euckr')
x_test=pd.read_csv('../데이터분석연습/x_test.csv', encoding='euckr')
y_train=pd.read_csv('../데이터분석연습/y_train.csv', encoding='euckr')
